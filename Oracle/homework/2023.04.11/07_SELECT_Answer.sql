...
--급여가 3500에서 5000사이에 있고 부서번호가 01~10 직원목록 조회
SELECT *
    FROM EMP
    WHERE SAL BETWEEN 3500 AND 5000
...
SELECT *
    FROM PROFESSOR
    WHERE HIREDATE BETWEEN TO_DATE('19940101 00:00:00', 'yyyyMMdd HH24:mi:ss') AND TO_DATE('19980202 23:59:59', 'yyyyMMdd HH24:mi:ss');
